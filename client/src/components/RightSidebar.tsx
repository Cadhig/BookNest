    ...
    return (
        <div className="w-full lg:w-1/4 mt-4">
            <div className="flex gap-2 w-full justify-center">
                <input type="text" placeholder='Search by Author or Title' className="border border-book-sage w-3/4 lg:w-1/2 flex-shrink-0 rounded-full p-2" onChange={(e) => setBook(e.target.value)} />
